...
void main() {
  ...
  test('refreshSession guarda nuevos tokens cuando el endpoint responde correctamente', () async {
    ...
    final result = await AuthRepository.refreshSession(tokenStorage, client: mockDio);
  ...
  test('refreshSession devuelve false si no hay refresh token en storage', () async {
    SharedPreferences.setMockInitialValues({});
    final mockDio = MockDio();
    final tokenStorage = TokenStorage();
